...
import { handleCompressFiles } from "./file_system/compress.js";
import { handleDecompressFiles } from "./file_system/decompress.js";
import { handleHttpProxyRequest } from "./network/http_proxy.js";
...
export const toolHandlers: Record<string, ToolHandler> = {
    ...
    compress_files: bind(handleCompressFiles),
    decompress_files: bind(handleDecompressFiles),
    http_proxy_request: bind(handleHttpProxyRequest),
...
export const toolSchemas: Record<string, z.ZodType> = {
    ...
    compress_files: schemas.CompressFilesSchema,
    decompress_files: schemas.DecompressFilesSchema,
    http_proxy_request: schemas.HttpProxyRequestSchema,
